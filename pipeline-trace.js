...
async function main() {
  ...
  if (job === 'Build') {
    ...
    steps = [
      // Insert child span for deploy duration, if env vars are set
      {
      ...
      },
      {
        ...
        run: async () => {
          ...
          // Example: curl your app's endpoint (adjust URL to your app)
      ...
      },
      {
        ...
        run: async () => {
          ...
          // Example: curl your app's homepage (adjust URL to your app)
